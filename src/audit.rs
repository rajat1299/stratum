...
mod tests {
    ...
    #[test]
    fn private_beta_audit_actions_round_trip_and_export_by_class() {
        let cases = [
            (
                AuditAction::WorkspaceCreate,
                "workspace_create",
                AuditExportClass::Workspace,
            ),
            (
                AuditAction::WorkspaceTokenIssue,
            ...
            (
                AuditAction::FsWriteFile,
                "fs_write_file",
                AuditExportClass::FilesystemMutation,
            ),
            (
                AuditAction::FsMkdir,
                "fs_mkdir",
            ...
            (
                AuditAction::VcsCommit,
                "vcs_commit",
                AuditExportClass::VersionControl,
            ),
            (
                AuditAction::VcsRevert,
                "vcs_revert",
            ...
            (
                ...
                AuditExportClass::ChangeRequest,
            ),
            (
                AuditAction::ChangeRequestApprove,
        ...
        for (action, serialized, class) in cases {
            assert_eq!(
            ...
            assert_eq!(AuditExportClass::from_action(action), class);
        }
    }
