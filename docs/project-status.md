...
- Baseline on `v2/foundation` before the current slice: `51feef2` (`feat: add durable cleanup claim foundation`)
- Latest completed slice: Postgres migration runner foundation
