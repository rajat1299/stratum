...
- Baseline on `v2/foundation` before the latest backend slice: `fe69456` (`feat: add object upload staging foundation`)
- Latest completed backend slice: durable cleanup claims and orphan repair foundation
